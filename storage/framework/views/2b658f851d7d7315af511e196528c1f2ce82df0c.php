...
<div class="row">
   ...
   <form  class="form-horizontal form-label-left" method="post" action="<?php echo e(URL::to('r-alumnos')); ?>">
                    ...
                    <tr>
                       ...
                       <div class="form-group <?php echo e($errors->has('nombre') ? 'has-error':''); ?>">
                        ...
                        <div class="form-group <?php echo e($errors->has('cc') ? 'has-error':''); ?>">
                            ...
                            <div class="col-md-8 col-sm-10 col-xs-12">
                                <?php echo Form::text('cc',null, ['class'=>'form-control col-md-7 col-xs-12']); ?>

                                <?php echo $errors->first('cc','<span class="help-block">:message</span>'); ?>

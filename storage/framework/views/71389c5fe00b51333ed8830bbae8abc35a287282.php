    ...
    <div class="col-md-5 col-sm-5 col-xs-8">
                  ...
                  <table class="" style="width:100%">
                    ...
                    <tr>
                        ...
                        <div class="form-group <?php echo e($errors->has('fecha_aprobacion') ? 'has-error':''); ?>">
                            ...
                            <div class="col-md-12 col-sm-10 col-xs-12">
                                <?php echo Form::text('fecha_aprobacion',null, ['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'AAAA-MM-DD']); ?>

                                <?php echo $errors->first('fecha_aprobacion','<span class="help-block">:message</span>'); ?>

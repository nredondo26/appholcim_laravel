...
<div class="row">
   ...
   <form  class="form-horizontal form-label-left" method="post" action="<?php echo e(URL::to('u-perfil')); ?>">
                    ...
                    <tr>
                       ...
                       <div class="form-group <?php echo e($errors->has('nombre') ? 'has-error':''); ?>">
                            ...
                            <div class="col-md-8 col-sm-10 col-xs-12">
                                <?php echo Form::text('nombre',Auth::guard('usuarios')->user()->nombre, ['class'=>'form-control col-md-7 col-xs-12']); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('email') ? 'has-error':''); ?>">
                            ...
                            <div class="col-md-8 col-sm-10 col-xs-12">
                                <?php echo Form::email('email',Auth::guard('usuarios')->user()->email, ['class'=>'form-control col-md-7 col-xs-12']); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('password') ? 'has-error':''); ?>">
                            ...
                            <div class="col-md-8 col-sm-10 col-xs-12">
                                <?php echo Form::password('password',null, ['class'=>'form-control col-md-7 col-xs-12']); ?>

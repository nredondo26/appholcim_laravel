...
<div class="container">
  <div>
    ...
    <div class="contenido">
      ...
      @foreach($nombre as $keynombre)
      <h6><p>Que el señor (a) {{$keynombre->nombre }} identificado con cédula de ciudadanía {{$keynombre->cc}} Realizo los procesos de formación trabajo seguro en altura registrando los siguientes cursos :</p></h6>
      @endforeach
    </div>
    ...
    <div class="cursos">
        ...
        <p><strong>Curso : {{ $key->nomcurso }} </strong></p>
        <p><strong>Fecha de Aprobacion : {{ $key->fechaaprobacion }} </strong></p>
        @endforeach
